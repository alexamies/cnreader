...
func mockDictionaryConfig() DictionaryConfig {
...
func TestContainsWord0(t *testing.T) {
	c := "hello"
	ReadDict(config.LUFileNames(), mockValidator{}, mockDictionaryConfig())
...
func TestReadDict1(t *testing.T) {
	...
	ReadDict(fileNames, mockValidator{}, mockDictionaryConfig())
